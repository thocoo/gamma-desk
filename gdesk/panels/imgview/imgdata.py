...
class ImageStatistics(object):
    ...
    def histogram(self, step=1):
        return self.agg.histogram(step)
        
        
    def starts(self, step=1):
        return self.agg.starts(step)
                
    
    def step_for_bins(self, bins):
        return self.agg.step_for_bins(bins)
        
    
    @property    
    def bins(self):
        return self.agg.bins
        
        
    def stepsize(self, step):
        return self.agg.stepsize(step)
...
class ImageData:
    ...
    def set_mask(self, array=None, composition='sourceover', cmap=None, alpha=255, color=None):
    ...
    def set_layer(self, name, array=None, composition='sourceover', cmap='bmask', alpha=255, color=(255,0,0)):
        if array is None:
